 ...
 */
final class Version20210323160115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, username VARCHAR(20) NOT NULL, password VARCHAR(255) NOT NULL, roles TEXT DEFAULT NULL, PRIMARY KEY(id))');
